	...
	dm.project.GridPanel.superclass.constructor.call(this, {
                ...
                listeners:{
					rowdblclick : function(grid,row,e){
                        ...
                        //console.info("record : " + record.data.projectId);

                        require(['business/working/pile_info.js','systemSet/clearDateField.js'], function() {

                            var cmp = mainTab.getComponent("ext-iframe-16");
                            if (cmp){
                                mainTab.remove(cmp);
                            }
