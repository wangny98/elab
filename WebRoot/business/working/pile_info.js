...
function printGrid(projectName, projectBuilder,projectSupervisor,contractNumber,sectionName, pileDriverNumber, startTime, endTime){
	...
	var searchConditions = '<div><b><span style="font-size:25px;display:block;width:100%;text-align:center;">钉形水泥土双向搅拌桩现场记录表</span></b> ';
		...
		//searchConditions += ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ';
		searchConditions += '<br>';
		searchConditions +='<table width="1000" border="0"><tbody><tr>';
		searchConditions += '<td width="200px">承包单位: ' + projectBuilder + '</td> ';
        //searchConditions += ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ';
		searchConditions += '<td width="200px">监理单位: ' + projectSupervisor + '</td> ';
        //searchConditions += ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ';
        searchConditions += '<td width="200px">合同编号: ' + contractNumber + '</td> ';
        //searchConditions += ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ';
		searchConditions += '</tr><tr>';
		searchConditions += '<td width="200px">标段: ' + sectionName + '</td> ';
        //searchConditions += ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ';
		searchConditions += '<td width="200px">桩机编号: ' + pileDriverNumber + '</td> ';
		//searchConditions += ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ';
		searchConditions += '<td width="200px">开始时间: ' + startTime + '</td> ';
		//searchConditions += ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ';
		searchConditions += '<td width="200px">结束时间: ' + endTime + '</td>';
		//searchConditions += '<div> &nbsp;&nbsp; </div>';
		searchConditions +='</tr></tbody></table>';
